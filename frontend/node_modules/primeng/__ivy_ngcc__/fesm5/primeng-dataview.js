...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r93.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r100); var ctx_r99 = ɵngcc0.ɵɵnextContext(); return ctx_r99.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r94 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r94.rows)("first", ctx_r94.first)("totalRecords", ctx_r94.totalRecords)("pageLinkSize", ctx_r94.pageLinks)("alwaysShow", ctx_r94.alwaysShowPaginator)("rowsPerPageOptions", ctx_r94.rowsPerPageOptions)("dropdownAppendTo", ctx_r94.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r94.paginatorDropdownScrollHeight)("templateLeft", ctx_r94.paginatorLeftTemplate)("templateRight", ctx_r94.paginatorRightTemplate)("currentPageReportTemplate", ctx_r94.currentPageReportTemplate)("showCurrentPageReport", ctx_r94.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r101 = ctx.$implicit;
    var rowIndex_r102 = ctx.index;
    var ctx_r95 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r95.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r101, rowIndex_r102));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r96.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r105); var ctx_r104 = ɵngcc0.ɵɵnextContext(); return ctx_r104.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
